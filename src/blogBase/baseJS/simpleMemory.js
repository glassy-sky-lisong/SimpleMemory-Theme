...
if (initCheck()) {
    ...
    var sidebarHtml =
        ...
        '            <link href="https://cdn.jsdelivr.net/gh/glassy-sky-lisong/SimpleMemory-Theme@v1.2.2/src/blogBase/blogStyle/font-Playball.css" rel="stylesheet">' +
    ...
    window.cnblogsConfigDefault = {
        ...
        GhVersions: 'v1.1.9',   //GitHub发布版本或提交哈希值，根据版本加载代码。
        CnVersions: "",
...
function getVersionConfig() {
    ...
    if (window.cnblogsConfig.isVersionMapping) {
	    ...
	    [
                "1.1.8",
                "c6af946f88e29d58537626f3f5537514fa113c0f"
            ],
	    [
		"v1.1.6",
		...
		"afb604cdd80d5fb5a86a691da68a780ef71e843b"
            ...
            [
                "v1.0.6",
                "8be22428fce676aeac889dd5fc19dbb8cbc524fc"
            ]
            ,
            [
                "v1.0.5",
                "fefe05f1c39ca068ad3b9c65a5f48b31617704df"
            ]
            ,
            [
                "v1.0.4",
                "705960e614c38fbacdaf349ce2e9aaaf92f2a5da"
            ]
            ,
            [
                "v1.0.3",
